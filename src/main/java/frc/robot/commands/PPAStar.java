...
public class PPAStar extends CommandBase {
  ...
  public void initialize() {
    ...
    for (int i = 0; i < fullPath.size(); i++) {
      if (i == 0) {
        System.out.println("X: "+startPoint.getX()+"\tY:"+startPoint.getY()+"\tHeading"+startPoint.getHolRot().getDegrees());
        ...
        System.out.println("X: "+finalPosition.getX()+"\tY:"+finalPosition.getY()+"\tHeading"+finalPosition.getHolRot().getDegrees());
        ...
        System.out.println("X: "+fullPath.get(i).getX()+"\tY:"+fullPath.get(i).getY()+"\tHeading"+finalPosition.getHolRot().getDegrees());
