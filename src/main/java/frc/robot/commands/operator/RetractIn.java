...
public class RetractIn extends SequentialCommandGroup {
  /** Creates a new MoveArmToSetpoint. */
  public RetractIn(ElevatorSubsystem elevator, ExtensionSubsystem extension, WristSubsystem wrist,
      ArmSetpoint setpoint) {

    addCommands(
      new MoveElevatorExtension(extension, setpoint.getLength()),
        new ParallelCommandGroup(
            // new MoveElevatorExtension(extension, Units.inchesToMeters(1)),
