...
public class PPAStarCopy extends CommandBase {
  ...
  public PPAStarCopy(DrivetrainSubsystem d, PoseEstimatorSubsystem p, PathConstraints constraints, Node finalPosition,
